...
2. **An integrated project.** After `/workflow-init` has run, the target project gets a copy of all
   playbooks under `docs/playbooks/`, plus thin wrapper skills/commands under `.claude/skills/`
...
- [impl-review-notes.md](./impl-review-notes.md) — fix unchecked Architect Review Notes with explore/plan/implementation metadata
